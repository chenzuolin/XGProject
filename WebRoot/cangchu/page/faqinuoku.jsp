...
<script src="cangchu/js/faqinuoku.js"></script>
...
<body onload="load()" ondragstart="return false">
	...
	<div id="mainFrame" class="main">
		...
		<div class="middle_content">
			<form
				action="${pageContext.request.contextPath}/shift.do?flag=saveShift"
				method="post" name="shiftForm" id="faqiForm">
				<!-- 该隐藏域用来保存挪库的发起人的id -->
				<input type="hidden"
						...
						<thead>
							<tr>
								<th class="tr_border_left"><label for="quanxuan">全选</label>
									<input type="checkbox" id="quanxuan" /></th>
								<th>库位</th>
								<th>货物品类</th>
								<th>名称</th>
								<th>助记符</th>
