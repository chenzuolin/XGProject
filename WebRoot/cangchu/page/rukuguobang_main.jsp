...
<script src="cangchu/js/sibang.js"></script>
	...
	function tiaozhuanruku(str) {
		$(function() {
			...
			if (confirm("确定要开始作业吗？")) {
				...
				// id
				document.location.href = "inputOperate.do?flag=selectSiBangChuli&caozuoid="
						+ caozuoid;
			}
		});
	}
	...
	<div id="mainFrame" class="main">
		...
		<div class="daohang">
			<ul>
				...
				<span>></span>&nbsp;
				<a href="javascript:document.location.reload();">订单过磅</a>
				<span>/</span>&nbsp;
			</ul>
		</div>
						...
						<table cellpadding="0" cellspacing="0">
							<tbody>
								...
								<tr class="tr_diaodu_bg">
									...
									<td align="right"><strong>件数：</strong>
									</td>
									<td class="tr_border_right_xia"><span>${operate.ioperateRealityNumber}</span>
									</td>
