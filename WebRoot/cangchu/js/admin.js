$(function() {
	...
	// 默认将第一个显示
	$(".middle_left .middle_left_span .middle_left_a:first").css("display",
			"block");

	/* 判断浏览器的窗口，如果小于隐藏，大于显示 */
	...
	$("#switch").toggle(
			function() {
				$(".middle_left").animate(
						...
						100,
						function() {
							$(".middle_left").removeClass("head_visable")
									.addClass("head_hide");
						});
				$("#context").animate({
				...
				$(".hide_switch").css("display","block");

			},
			function() {
				$(".middle_left").removeClass("head_hide").addClass(
						"head_visable").animate({
					"opacity" : "1",
					"width" : "250px",
				}, 100, function() {
				});
				...
				$(".hide_switch").css("display","none");
			});

	// 默认显示第一个的样式

	$(".middle_left .middle_left_span span").first().css({
		"background" : "url(cangchu/img/left2.png) no-repeat left",
		"color" : "#38A3D5"
	});

	$(".middle_left .middle_left_span .middle_left_a a").first().addClass(
			"middle_left_aclick");
	$(".middle_left .middle_left_span .middle_left_a a").first().css(
			"border-left", "5px solid red");
	$(".middle_left .middle_left_span .middle_left_a a p").first()
			.children("p").addClass("middle_left_p");

	// 当点击左侧标题的时候
	$(".middle_left .middle_left_span span").click(function() {
		$(".middle_left .middle_left_span span").css({
			"background" : "url(cangchu/img/left.png) no-repeat left",
			"color" : "#000000"
		});
		$(this).css({
			"background" : "url(cangchu/img/left2.png) no-repeat left",
	...
	// 当点击a标签的时候
	$(".middle_left .middle_left_span .middle_left_a a").click(
			function() {
				$(".middle_left .middle_left_span .middle_left_a a").css(
						"border-left", "5px solid #FFFFFF");
				$(".middle_left .middle_left_span .middle_left_a a")
						.removeClass("middle_left_aclick");
				$(".middle_left .middle_left_span .middle_left_a a p")
						.removeClass("middle_left_p2 middle_left_p");
	...
	// 当进入的时候
	$(".middle_left .middle_left_span div a  p")
			.mouseover(
					function() {
						if ($(this).parent("a").hasClass("middle_left_aclick") == false) {
							$(".middle_left .middle_left_span div a p")
									.removeClass("middle_left_p2");
							$(this).addClass("middle_left_p2");
							$(this).parent("a").css("border-left",
									"5px solid #E2E2E2");
						}
					});
...
// 消息框的显示
$(function() {
	$(".shandong").hover(function() {
		$(".tixing").css("display", "block");
	}, function() {
		$(".tixing").hover(function() {
			$(".tixing").css("display", "block");
		}, function() {
