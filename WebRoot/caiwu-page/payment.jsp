 ...
 <script type="text/javascript">
  	$(function(){
		...
		$(".closeOk").click(function(){
			document.location.href="${pageContext.request.contextPath}/paymentFashion.do?flag=getAll";
		});	
  	});
  	function fun(){
  ...
  <div id="mainFrame" class="main">
      <div class="daohang">
          <ul>
              ...
              <a href="javascript:document.location.reload();">支付方式</a> <span>/</span>&nbsp;
          </ul>
      </div>
      <div class="container">
          <ul class="nav nav-tabs nav-pills" style="margin: 10px 2.5%; font-weight: bold;">
              <li class="active">
                  <a data-toggle="tab" href="#home">
                      <span class="glyphicon glyphicon-list" aria-hidden="true" style="margin-right: 8px;"></span>支付方式列表</a>
              </li>
              <li>
                  <a data-toggle="tab" href="#menu1">
                      <span class="glyphicon glyphicon-plus" aria-hidden="true" style="margin-right: 8px;"></span>新增支付方式</a>
              </li>
          </ul>
              ...
              <div id="home" class="tab-pane fade in active">
                  <table class="table table-striped table-hover">
                    ...
                    <c:if test="${pflist==null }">
                		<c:redirect url="/paymentFashion.do?flag=getAll"/>
                	</c:if>
                	<c:forEach items="${pflist }" var="lp" varStatus="v">
                    <tr>
                        <td>${v.index+1 }<input type="hidden" class="id" value="${lp.pfashionId }"></td>
                        <td>${lp.pfashionName }</td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title"> 停用支付方式</h4>
                                        </div>
                 ...
                 <div id="menu1" class="tab-pane fade">
                     <div class="modal-content" style="margin: auto 30%;">
                         <div class="modal-header">
                             <h4 class="modal-title" id="myModalLabel">新增支付方式</h4>
                         </div>
                         <form  class="form-horizontal" 
                   method="post"  name="paymentFashionForm" 
                   action="${pageContext.request.contextPath}/paymentFashion.do?flag=savePaymentFashion" onSubmit="return fun()">
                         <div class="modal-body">
                   
                                 <div class="form-group">
                                     <label for="zffs" class="col-sm-3 control-label">支付方式</label>
                                     <div class="col-sm-7">
                                         <input type="text" class="form-control zffs" name="pfashionName">
                                     </div>
                                 </div>       
                                 <div class="form-group">
                 ...
                 <div id="menu2" class="tab-pane fade">
                     <div class="modal-content" style="margin: auto 30%;">
                         <div class="modal-header">
                             <h4 class="modal-title" id="myModalLabel">编辑支付方式</h4>
                         </div>
                         <form class="form-horizontal"  name="paymentFashionForm" 
                       method="post" action="${pageContext.request.contextPath}/paymentFashion.do?flag=updatePaymentFashion" onSubmit="return fun2()">
                         <div class="modal-body">
                                 ...
                                 <div class="form-group">
                                     <label for="zffs1" class="col-sm-3 control-label">支付方式</label>
                                     <div class="col-sm-7">
                                         <input type="text" class="form-control" id="zffs" name="pfashionName">
                                     </div>
                                 </div>
                                 <div class="form-group">
