...
<script src="js/chukudingdanupdate.js"></script>
...
<body>
	...
	<div id="mainFrame" class="main">
		<div class="daohang">
			<ul>
				...
				<span>/</span>&nbsp;
				<a href="javascript:window.history.go(-1);">出库详情</a>
				<span>/</span>&nbsp;
				<a href="javascript:document.location.reload();">出库订单修改</a>
				<span>/</span>&nbsp;
			</ul>
		</div>
		<%
			...
			<div class="tab-content">
				<div id="home" class="tab-pane fade in active">
					<table class="table table-striped table-hover">
						...
						<tbody>
							<c:forEach items="${eolist }" var="eo" varStatus="eos">
								<tr>
				...
				<div id="timeupdate" class="tab-pane fade">
					<div class="modal-content" style="margin: auto 30%;">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">修改出库订单发起时间</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" role="form"
								action="${pageContext.request.contextPath }/export.do?flag=UpdateTime"
								name="exportForm" id="timeupdateform" method="post">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="timeupdateId" class="form-control" readonly="readonly"
											value="${es.export.exportId }" name="exportId" />
									</div>
								</div>

								<div class="form-group" >
									<div class='input-group date col-md-6 col-xs-8 ' style="margin:0px auto;">
										<input class="form-control" type="text" id="endTime"
											placeholder="日期修改" name="exportReateTime" /> <span class="input-group-addon"><label
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										...
										<select class="form-control" id="zhixing"
											name="interiorUserByEoperateStoreman">
										</select>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<div id="guigeDiv1" class="zhuangxie">
											<select id="zhuangxie" class="demo-default">
						...
						<tbody>
							<c:forEach items="${eolist }" var="eo" varStatus="eos">
								<tr>
									...
									<td>${eo.eoperateRealityWeight }</td>
									<td>${eo.eoperateRealityNumber }</td>
									<td>${eo.eoperateShouldCost }</td>
									<td>${eo.eoperateRealityCost }</td>
									<td>${eo.eoperateClientAccounts }</td>
									<td>${eo.eoperatePaymentFashion.pfashionName }</td>
									<td>${eo.eoperatePaymentFashion.pfashionReceipt }<input
										type="hidden" value="${eo.eoperatePaymentFashion.pfashionId }"
										id="pj" />
									</td>
									<td><a type="button" class="btn btn-warning btn-xs"
						...
						<div class="modal-body">
							<form class="form-horizontal" role="form"
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="yscost"
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<select class="form-control" id="jiesuan"
											name="eoperateClientAccounts">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<select class="form-control" id="piaoju"
											name="eoperatePaymentFashion">
										</select>
									</div>
								</div>
								<div class="form-group">
									<label for="beizhu1" class="col-sm-3 control-label">备注</label>
									<div class="col-sm-7">
										<input type="text" name="eoperateRemark" class="form-control"
											id="beizhu1" />
									</div>
								</div>
							</form>
	...
	<div id="updateshenqing" class="tab-pane fade">
		<div class="modal-content" style="margin: auto 30%;">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">修改出库订单申请</h4>
			</div>
			<div class="modal-body">
				<form
					...
					<input type="hidden" value="${es.eseedId }" name="urziid" /> <input
						type="hidden" value="${es.export.exportId }" name="urzongid" /> <input
						type="hidden" value="出库订单" name="urupdatetype" />
					<div class="form-group">
