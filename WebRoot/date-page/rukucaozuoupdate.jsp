...
<script src="js/rukucaozuoupdate.js"></script>
						...
						<tbody>
							<tr>
								<td>${io.inputSeed.input.inputId }<input type="hidden"
									value="${io.inputSeed.goods.goodsId }" id="goodsId" /> <input
									type="hidden" value="${io.ioperateDefinedTwo }" id="zt" />
								</td>
								<td>${io.ioperateId }</td>
					...
					<div class="modal-content" style="margin: auto 30%;">
						...
						<div class="modal-body">
							<form class="form-horizontal" role="form"
								action="${pageContext.request.contextPath }/inputOperate.do?flag=updateTarehouse"
