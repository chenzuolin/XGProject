	...
	<div class="right" id="mainFrame">
		<div class="daohang">
			<ul>
				...
				<span>></span>&nbsp;
				<a href="javascript:document.location.reload();">客户库存查询</a>
				<span>/</span>&nbsp;
			</ul>
		</div>
		<!-- selectize.js 单选插件 -->
			...
			<div class="col-lg-2 col-xs-6">
				<div class="input-group form-group">
					<input type="text" class="form-control" placeholder="货物名称"
						id="huowu"> <span class="input-group-addon">货物名称</span>
				</div>
			</div>
		</div>
		<div class="options"
			...
			<div class="col-lg-2 col-xs-6">
				<div class="input-group form-group">
					<input type="text" class="form-control" placeholder="货物规格"
						id="guige"> <span class="input-group-addon">货物规格</span>
				</div>
			</div>
			<div class="col-lg-2 col-xs-6">
				<div class="input-group form-group">
					<input type="text" class="form-control" placeholder="货物材质"
						id="caizhi"> <span class="input-group-addon">货物材质</span>
				</div>
			</div>
			<div class="col-lg-2 col-xs-6">
				<div class="input-group form-group">
					<input type="text" class="form-control" placeholder="货物属性"
						id="shuxing"> <span class="input-group-addon">货物属性</span>
				</div>
			</div>
			<div class="col-lg-2 col-xs-6">
				<div class="input-group form-group">
					<input type="text" class="form-control" placeholder="货物产地"
						id="chandi"> <span class="input-group-addon">货物产地</span>
				</div>
			</div>
		...
		<table class="table table-bordered" style="min-width: 1000px;">
			<tr>
				<td colspan="14" align="left"><input type="checkbox"
					id="shaixuan" /><label for="shaixuan">筛选当页无业务客户</label>
				</td>
			</tr>
		</table>
		<!-- 以下为数据内容 -->
...
<script>
	$(function() {
		...
		$("#guige").keydown(function(event) {
			if (event.keyCode == 13) {
				$("#tijiao").click();
			}
		});
		$("#caizhi").keydown(function(event) {
			if (event.keyCode == 13) {
				$("#tijiao").click();
			}
		});
		$("#shuxing").keydown(function(event) {
			if (event.keyCode == 13) {
				$("#tijiao").click();
			}
		});
		$("#chandi").keydown(function(event) {
			if (event.keyCode == 13) {
				$("#tijiao").click();
			}
		});
