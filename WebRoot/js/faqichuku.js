$(function() {
	...
	$("#tijiao").click(function() {
		...
		if(chehao == "" || !chehaoyan.test(chehao)) {
			$("#chehao").siblings("img").attr("src", "../img/err.png");
			alert("车号不能为空且请填写有效的车号");
			return;
		}
		//验证司机姓名
		if(siji == "") {
			$("#siji").siblings("img").attr("src", "../img/err.png");
			alert("司机姓名不能为空");
			return;
		}
		...
		if(sijitel == "" || !telyanzheng.test(sijitel)) {
			$("#sijitel").siblings("img").attr("src", "../img/err.png");
		...
		//验证出库单号
		if(rukudanhao == "") {
			$("#rukudanhao").siblings("img").attr("src", "../img/err.png");
			alert("提货单号不能为空");
			return;
		}
		...
		for(var i = 0; i < $("#tab_context .tab_bottom").length; i++) {
			...
			if(zhongliang == "" || !zhongyan.test(zhongliang)) {
				$("#tab_context .tab_bottom").eq(i).find("#rukuzhongliang").siblings("img").attr("src", "../img/err.png");
				alert("请填写货物重量");
				return;
				break;
			}
	...
	$("#delete").hover(function() {
		$(this).children("img").attr("src", "../img/delete_one.png");
	}, function() {
		$(this).children("img").attr("src", "../img/delete_two.png");
	});
	...
	$(".queren a:last").css({
		...
		"height": "30px",
		"line-height": "30px",
		"background": "url(../img/zengjiahuowu.png)",
		"color": "#FFFFFF",
		"text-align": "center",
		"font-weight": "bold"
	});
	$(".queren a:last").hover(function() {
		$(this).css({
			"background": "url(../img/zengjiahuowu2.png)"
		});
	}, function() {
		$(this).css({
			"background": "url(../img/zengjiahuowu.png)"
