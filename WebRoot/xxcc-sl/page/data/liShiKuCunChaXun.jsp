...
<html>
	...
	<head>
		...
		<!--自写js-->
		<script src="js/liShiKuCunChaXun.js"></script>
	</head>
				...
				<form class="layui-form layui-form-pane">
					<div class="layui-row layui-col-space30">
						...
						<div  class="layui-col-xs12 layui-col-sm6 layui-col-md4">
							...
							<div class="layui-input-block">
								<input type="text" name="goodsPinLei" placeholder="请输入货物品类" id="goodsPinLei" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
