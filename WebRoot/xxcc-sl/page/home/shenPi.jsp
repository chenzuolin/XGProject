	...
	<body>
		<div class="layui-fluid">
					...
					<div class="layui-row layui-col-space30">
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="text" placeholder="请输入申请人" name="shenqingren" id="shenqingren" class="layui-input">
							</div>
						</div>
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
						...
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
							...
							<a class="layui-btn layui-btn-primary" id="jilu">审批记录</a>
						</div>
					</div>
				</fieldset>
			</form>
			...
			<script type="text/html" id="barDemo">
				<a class="layui-btn layui-btn-sm" lay-event="detail"><span class="layui-icon">&#xe61d;</span>审批</a>
			</script>
	...
	<script>
		layui.use(['element', 'form', 'table', 'layer', 'laydate'], function() {
			...
			$("#jilu").click(function() {
				var indexu = layer.open({
					type: 2,
					title: ['订单审批', 'font-size:16px;'],
					skin: 'layui-layer-blue',
					closeBtn: 1,
					content: '/XGProject/xxcc-sl/page/home/shenPiJiLu.jsp',
					resize: true, //默认：true
				});
				layer.full(indexu);
			});
			...
			table.on('tool(demo)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
				...
				if(data.id != null && data.id != undefined && data.id != "") {
					...
					var indexu = layer.open({
						...
						skin: 'layui-layer-blue',
						closeBtn: 1,
						content: '/XGProject/updateRecordAction.do?flag=getXiangQing&urid=' + data.id,
						resize: true, //默认：true
					});
					layer.full(indexu);
				}
		...
		function show() {
			layui.use(['jquery', 'layer', 'table'], function() {
				...
				$.ajax({
					type: "post",
					url: "/XGProject/updateRecordAction.do?flag=getShenPiZhong",
					async: true,
					data: {
						"begin": begin,
						"finish": finish,
