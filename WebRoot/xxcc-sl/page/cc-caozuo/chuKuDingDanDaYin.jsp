      ...
      <div class="layui-container">
         ...
         <table class="layui-table title" style="border: 0;">
            <tr>
               ...
               <td class="con">${es.export.client.clientFirmName}</td>
               <td class="tit">仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库：</td>
            ...
            <tr>
               ...
               <td class="con">${es.export.exportClientNumber}</td>
               <td class="tit">订单编号：</td>
               <td class="con">${es.export.exportId}</td>
            </tr>
            <tr>
               <td class="tit">车&nbsp;牌&nbsp;号：</td>
               <td class="con">${es.export.exportWagonNumber }</td>
               <td class="tit">司机姓名：</td>
               <td class="con">${es.export.exportDriverName}</td>
               <td class="tit"></td>
               <td class="con"></td>
            </tr>
         </table>
         ...
         <table class="layui-table">
            ...
            <tbody>
               <c:if test="${list!=null }">
                  <c:forEach items="${eolist }" var="eol">
                     <tr>
                        <td>鑫港库</td>
                        ...
                        <td>${eol.eoperatePonderationTrue }</td>
                        <td></td>
                        <td class="theory_w">${es.eseedShouldWeight}</td>
                        <td class="reality_j">${eo.eoperateRealityNumber==null?"0":eo.eoperateRealityNumber}</td>
                        <td class="reality_w">${eo.eoperateRealityWeight==null?"0":eo.eoperateRealityWeight}</td>
                     </tr>
                  </c:forEach>
               </c:if>
               <c:if test="${list==null }">
               ...
               <tr height="50px ">
                  <td colspan="7 ">备注</td>
                  <td></td>
                  <td id="theoryTotal_w">${es.eseedShouldWeight}</td>
