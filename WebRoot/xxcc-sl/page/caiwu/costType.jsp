	...
	<div class="layui-fluid">
		<fieldset class="buttons">
			...
			<button class="layui-btn" id="ADD">
				<i class="fa fa-plus" style="padding-right: 6px;"></i>新增费用类型
			</button>
		</fieldset>
		<!--表格内容-->
		<table id="demo" lay-filter="datatable"></table>
		<script type="text/html" id="barDemo">
            <a class="layui-btn layui-btn-sm" lay-event="edit"><span class="layui-icon">&#xe642;</span>编辑</a>
		...
		<form class="layui-form" action="">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="cost" class="layui-input" id="cost1"
						readonly="readonly">
				</div>
			</div>
			<div class="layui-form-item">
...
<script>
      ...
      layui.use(['table', 'form'], function() {
         ...
         $.ajax({
            type: 'post',
            url: '/XGProject/costType.do?flag=getCostTypeAll',
            async: false,
            dataType: 'json',
         ...
         form.on('submit(btn1)', function(obj) {
            ...
            var datas = {
               'ctypeId': hangID,
               'ctypeName': data.cost,
               'ctypeCost': data.money,
               'ctypeRemark': data.remark,
            };
            var bianji = goodsContent('/XGProject/costType.do?flag=updateCostType', datas, 'text');
            if(bianji == 'error') {
               layer.alert('数据上传错误', {
                  icon: 2
               })
...
//             icon: 3
//          }, function() {
//             var tianjia = goodsContent('/XGProject/', datas, 'text');
//             if(tianjia == 'error') {
//                layer.alert('数据上传错误！', {
//                   icon: 2
//                })
