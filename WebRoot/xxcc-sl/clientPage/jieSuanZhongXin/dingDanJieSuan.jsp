...
<html>
	...
	<body>
					...
					<div class="layui-row layui-col-space30">
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="text" name="kehudanaho" placeholder="请输入客户单号" id="kehudanaho" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
						...
						<div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="text" name="goodsName" placeholder="请输入货物名称" id="goodsName" autocomplete="off" class="layui-input">
							</div>
						</div>
					</div>
					<div class="layui-row layui-col-space30">
		...
		<!--自写js-->
		<script src="js/dingDanJieSuan.js"></script>
		<script>
			inputBg();
		</script>
	</body>
