	...
	<body>
		<div class="layui-fluid">
			<form class="layui-form layui-form-pane" action="">
				<fieldset>
					<legend>客户信息</legend>
					<input type="hidden" value="${clientId}" lay-verify="required" id="client" name="clientIn">
					<div class="layui-row layui-col-space30">
						...
						<div class="layui-col-xs12  layui-col-sm6 layui-col-md3 ">
							...
							<div class="layui-input-block">
								<input type="text" name="driverName" class="layui-input">
							</div>
						</div>
						<div class="layui-col-xs12  layui-col-sm6 layui-col-md3 ">
							<label class="layui-form-label">司机电话</label>
							<div class="layui-input-block">
								<input type="text" name="driverTel" class="layui-input">
							</div>
						</div>
					</div>
				</fieldset>
