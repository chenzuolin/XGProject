            ...
            <div class="sidebar-collapse">
                <ol class="nav collapse " id="main-menu">
                    ...
                    <li>
                        ...
                        <ol class="nav nav-second-level collapse">
                            <li>
                                <a href="indent-jiesuan.html"><i class="fa fa-coffee"></i>订单结算</a>
                            </li>
                            <li>
                                <a href="jiesuanhuizong.html"><i class="fa fa-file-text "></i>结算汇总</a>
                            </li>
                            <li>
                                <a href="payment.html"><i class="fa fa-key "></i>缴费记录</a>
                            </li>
                            <!-- 
	                            <li>
                    ...
                    <li>
                        ...
                        <ol class="nav sjzx collapse">
                            ...
                            <li>
                                <a href="sfc-form.html"><i class="fa fa-file-text "></i>收发存报表</a>
                            </li>
                            <li>
                                <a href="inventory.html"><i class="fa fa-file-text "></i>库存查询</a>
                            </li>
                        </ol>
                    </li>
                    <li>
                        ...
                        <ol class="nav nav-second-level collapse">
                            <li>
                                <a href="user-info.html"><i class="fa fa-user "></i>用户资料</a>
                            </li>
                            <li>
                                <a href="password.html"><i class="fa fa-flask "></i>修改密码</a>
                            </li>
                            <li>
                                <a id="zhuxiao" data-toggle="modal" data-target="#disable"><i class="fa fa-flask "></i>注销系统</a>
                            </li>
                        </ol>
                    </li>
                </ol>
        ...
        <div class="wrapper-inner">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <p class="panel-title" style="text-align: center;"><a href="javascript:document.location.reload();">订单编号：</a>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>备注</td>
                            <td>${shiftStockSeed.ssseedRemark}</td>
                        </tr>
                    </table>
                </div>
            </div>
