        ...
        <div class="wrapper-inner">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <p class="panel-title" style="text-align: center;"><a href="indent-detail.html">订单编号${exportSeed.eseedId }：</a>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>客户名称</td>
                            <td>${exportSeed.export.client.clientAbbreviation }</td>
                        </tr>
                        <tr>
                            <td>客户单号</td>
                        ...
                        <tr>
                            <td>货物重量</td>
                            <td>${exportSeed.eseedRealityWeight }</td>
                        </tr>                       
                        <tr style="color: red;">
                            <td>出库费</td>
                            <td>${exportSeed.eseedShouldCost }</td>
                        </tr>
                        <tr style="color: red;">
                            <td>实收费用(出)</td>
                            <td>${exportSeed.eseedRealityCost }</td>
                        </tr>
                        <tr style="color: red;">
                            <td>结算方式</td>
                            <td>${exportSeed.eseedClientAccounts }</td>
                        </tr>
                        <tr>
                            <td>收费人</td>
                            <td>${shoufeiRen }</td>
                        ...
                        <tr>
                            <td>备注</td>
                            <td>${exportSeed.export.exportRemark }</td>
                        </tr>
                    </table>
                </div>
            </div>
