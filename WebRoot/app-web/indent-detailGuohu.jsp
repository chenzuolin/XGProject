...
<link rel="stylesheet"
	href="app-web/css/bootstrap-datetimepicker.min.css">
	...
	<div class="container">
				...
				<ol class="nav collapse " id="main-menu">
					...
					<li><a class="1ji"><i class="fa fa-database "></i>数据中心</a>
						<ol class="nav sjzx collapse">
							...
							<li><a
								href="${pageContext.request.contextPath}/app-web/inventory.jsp"><i
		...
		<div class="wrapper-inner">
			<ol class="breadcrumb">
				...
				<li>数据中心</li>
				<li><a
					href="${pageContext.request.contextPath}/app-web/indent-search.jsp">订单查询</a>
				</li>
				<li>订单明细</li>
			</ol>
			<h3>订单明细</h3>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<p class="panel-title" style="text-align: center;">
						<a href="javascript:document.location.reload();">订单编号：${shiftStockSeed.ssseedId
							}</a> <span class="glyphicon glyphicon-chevron-down"
				...
				<div class="panel-body">
					<table class="table table-hover">
						...
						<tr>
							<td>客户名称</td>
							<td>${shiftStockSeed.shiftStock.clientBySstockClientId.clientAbbreviation
								}</td>
						</tr>
						<tr>
							<td>客户单号</td>
							<td>${shiftStockSeed.shiftStock.sstockClientNumber }</td>
						</tr>
						<tr>
							<td>转入单位</td>
							<td>${shiftStockSeed.shiftStock.clientBySstockShiftToFirm.clientAbbreviation
								}</td>
						</tr>
						<tr>
							<td>货物品类</td>
							<td>${shiftStockSeed.goods.goodsCategory.goodsCategoryName }</td>
						</tr>
						<tr>
							<td>货物名称</td>
						...
						<tr>
							<td>货物规格</td>
							<td>${shiftStockSeed.goods.goodsStandard.goodsStandardName }</td>
						</tr>
						<tr>
							<td>货物材质</td>
							<td>${shiftStockSeed.goods.goodsQuality.goodsQualityName }</td>
						</tr>
						<tr>
							<td>货物属性</td>
							<td>${shiftStockSeed.goods.goodsProperty.goodsPropertyName }</td>
						</tr>
						<tr>
							<td>货物产地</td>
							<td>${shiftStockSeed.goods.goodsYieldly.goodsYieldlyName }</td>
						</tr>
						<tr>
							<td>货物重量</td>
							<td>${shiftStockSeed.ssseedWeight}吨</td>
						</tr>
						<tr>
							<td>订单状态</td>
							<td>${shiftStockSeed.ssseedOrderStatus}</td>
						</tr>
						<tr>
							<td>完成时间</td>
						...
						<c:if test="${shiftStockSeed.ssseedOrderStatus=='正在审核'}">
							<tr>
								<td colspan="2" style="text-align: right;"><a
									class="btn btn-primary"
									href="${pageContext.request.contextPath }/shiftStockSeed.do?flag=goDingdanZuofei&id=${shiftStockSeed.ssseedId}">订单作废</a>
								</td>
							</tr>
						</c:if>
