...
<head>
   ...
   <link rel="stylesheet" href="app-web/css/bootstrap.min.css">
    ...
    <script src="app-web/js/appFaqichuku.js"></script>
    <style type="text/css">
       ...
       <!-- 模态框结束 --> 
        ...
        <div class="wrapper-inner">
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:document.location.reload();">出库订单</a></li>
            </ol>
            <h3>出库订单</h3>
            <form name="exportForm"
				action="${pageContext.request.contextPath}/export.do?flag=FaQiChuKuApp"
            ...
            <div class="dingdanye">
                <div style="margin-top: 20px; height: 100px;">
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                ...
                                <input id="kehuDanhao" type="text" class="form-control" name="exportClientNumber">
                        ...
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">运输方式</span>
                                 <select id="yunType" class="form-control" name="exportCarryType">
                        ...
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                ...
                                <input id="chehao" type="text" class="form-control" name="exportWagonNumber">
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">司机姓名</span>
                                <input id="sijiName" type="text" class="form-control" name="exportDriverName">
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">司机电话</span>
                                <input id="tel" type="text" class="form-control" name="exportDriverTel">
                            </div>
                        </div>
                         <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">有效期（天）</span>
                                <input id="youxiaoQi" type="text" class="form-control" name="exportDefinedTwo">
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">是否超发</span>
                                <input type="checkbox" value="接受超发"  name="exportDefinedOne" class="form-control" data-container="body" data-toggle="popover" data-placement="bottom" data-content="允许超发货物">
                            </div>
                        </div>
                         <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">配送</span>
                                <input type="checkbox" value="配送" id="peisong"  class="form-control" name="exportRemark"  data-container="body" data-toggle="popover" data-placement="bottom">
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-6 form-group" style="display:none;" id="lianxitel">
                            <div class="input-group">
                                <span class="input-group-addon">联系电话</span>
                                <input id="danweiTel" type="text" class="form-control" name="eseedDefinedOne">
                            </div>
                        </div>
                        <!-- 配送选择JavaScript -->
                        <script type="text/javascript">
                        	$(function(){
                        		$("#peisong").click(function(){
                        			if($(this).prop("checked")){
                        				$("#lianxitel").css("display","block");
                        			}else{
                        				$("#lianxitel").css("display","none");
                        			}
                        		});
                        	});
                        </script>
                ...
                <div style="margin-top: 20px; height: 200px;">
                        ...
                        <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">出库重量</span>
                                <input type="text" id="weights" class="form-control" name="exportShouldWeights">
                            </div>
                        </div>
                       	<!-- <div class="col-md-4 col-xs-6 form-group">
                            <div class="input-group">
                                <span class="input-group-addon">备注</span>
                                <input type="text" class="form-control" name="exportRemark">
                            </div>
                        </div>  -->         
                </div>
            </div>
