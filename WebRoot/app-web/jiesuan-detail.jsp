       ...
       <div class="header">
        ...
        <div class="wrapper-inner">
            <ol class="breadcrumb">
                <span>当前位置：</span>
                <li>结算中心</li>
                <li><a href="javascript:window.history.go(-1);">订单结算</a></li>
                <li>结算明细</li>
            </ol>
            <h3>结算明细</h3>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <p class="panel-title" style="text-align: center;"><a href="indent-detail.html">订单编号：${inputSeed.iseedId}</a>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>客户名称</td>
                            <td>${inputSeed.input.client.clientAbbreviation }</td>
                        </tr>
                        <tr>
                            <td>客户单号</td>
                        ...
                        <tr>
                            <td>货物重量</td>
                            <td>${inputSeed.iseedRealityWeight }</td>
                        </tr>
                        <tr>
                            <td>费用单价</td>
                            <td>${yunshu }</td>
                        ...
                        <tr style="color: red;">
                            <td>应收费用</td>
                            <td>${inputSeed.iseedShouldCost }</td>
                        </tr>
                         <tr style="color: red;">
                            <td>实收费用</td>
                            <td>${inputSeed.iseedRealityCost }</td>
                        </tr>
                         <tr style="color: red;">
                            <td>缴费人</td>
                            <td>xxxx</td>
