...
<head>
    ...
    <link rel="stylesheet" href="app-web/css/fenye.css">
    <script src="http://libs.baidu.com/jquery/2.1.1/jquery.min.js"></script>
    <script src="app-web/js/bootstrap.min.js"></script>
    <script src="app-web/js/kehuJiesuanHuizong.js"></script>
	  ...
	  <!-- 模态框结束 --> 
        ...
        <div class="wrapper-inner">
            <ol class="breadcrumb">
                <span>当前位置：</span>
                <li><a>结算中心</a></li>
                <li><a href="javascript:document.location.reload();">结算汇总</a></li>
            </ol>
            <h3>结算汇总</h3>
            ...
            <table class="table table-hover">
                <caption>2017/07/01-2017/07/31费用结算表（元）</caption>
                <thead>
                    <tr>
                        <th>时间（始）</th>
                        <th>时间（终）</th>
