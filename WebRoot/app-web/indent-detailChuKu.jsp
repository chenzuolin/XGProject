        ...
        <div class="wrapper-inner">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <p class="panel-title" style="text-align: center;"><a href="javascript:documnet.location.reload();">订单编号：${exportSeed.eseedId }</a>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        <tr>
                            <td>订单创建时间</td>
                            <td>${exportSeed.export.exportReateTime }</td>
                        </tr>
                        <tr>
                            <td>业务类型</td>
                            <td>出库订单</td>
                        ...
                        <tr>
                            <td>客户名称</td>
                            <td>${exportSeed.export.client.clientFirmName }</td>
                        </tr>
                        <tr>
                            <td>客户单号</td>
                            <td>${exportSeed.export.exportClientNumber }</td>
                        </tr>
                        <tr>
                            <td>运输方式</td>
                            <td>${exportSeed.export.exportCarryType }</td>
                        </tr>
                        <tr>
                            <td>车辆号码</td>
                            <td>${exportSeed.export.exportWagonNumber }</td>
                        </tr>
                        <tr>
                            <td>司机姓名</td>
                            <td>${exportSeed.export.exportDriverName }</td>
                        </tr>
                        <tr>
                            <td>司机电话</td>
                            <td>${exportSeed.export.exportDriverTel }</td>
                        </tr>
                        <tr>
                            <td>货物品类</td>
                            <td>${exportSeed.goods.goodsCategory.goodsCategoryName }</td>
                        </tr>
                        <tr>
                            <td>货物名称</td>
                            <td>${exportSeed.goods.goodsName }</td>
                        </tr>
                        <tr>
                            <td>货物规格</td>
                            <td>${exportSeed.goods.goodsStandard.goodsStandardName }</td>
                        </tr>
                        <tr>
                            <td>货物材质</td>
                            <td>${exportSeed.goods.goodsQuality.goodsQualityName }</td>
                        </tr>
                        <tr>
                            <td>货物属性</td>
                            <td>${exportSeed.goods.goodsProperty.goodsPropertyName }</td>
                        </tr>
                        <tr>
                            <td>货物产地</td>
                            <td>${exportSeed.goods.goodsYieldly.goodsYieldlyName }</td>
                        </tr>
                        <tr>
                            <td>货物重量</td>
                            <td>${exportSeed.eseedShouldWeight}吨</td>
                        </tr>
                        <tr>
                            <td>订单状态</td>
                            <td>${exportSeed.eseedOrderStatus}</td>
                        </tr>
                        <tr>
                            <td>完成时间</td>
                            <td>${finishTime}</td>
                        ...
                        <tr>
                            <td>备注</td>
                            <td>${exportSeed.eseedRemark}</td>
                        </tr>
                        <c:if test="${exportSeed.eseedOrderStatus=='计划出库'}">
	                        <tr>
                            	<td colspan="2" style="text-align: right;"><a class="btn btn-primary" 
                           		href="${pageContext.request.contextPath }/exportSeed.do?flag=goDingdanZuofei&id=${exportSeed.eseedId}">取消订单</a> </td>
                        	</tr>
                        </c:if> 
