...
function selectRuku() {
		...
		$.ajax({
			...
			url :"inputSeed.do?flag=getDingdanApp",
			dataType : "json",
								...
								.append(
									"<div class='panel panel-primary divStyle'>" +
											...
											"<div class='panel-heading'>" +
												"<p class='panel-title'>订单编号:"+item.zongId+"" +
...
function selectRukuBut() {	
	...
	$.ajax({
		...
		url :"inputSeed.do?flag=getDingdanAppTj",
		dataType : "json",
		success : function(obj) {
			if (obj.qingkong == "clean") {
				alert("没有数据！");
...
function selectChuku() {
		...
		$.ajax({
			...
			url :"exportSeed.do?flag=getDingdanApp",
			dataType : "json",
			success : function(obj) {
				if (obj.qingkong == "clean") {
					alert("没有数据！");
...
function selectChukuBut() {	
	...
	$.ajax({
		...
		url :"exportSeed.do?flag=getDingdanAppTj",
		dataType : "json",
		success : function(obj) {
			if (obj.qingkong == "clean") {
				alert("没有数据！");
...
function selectGuohu() {
		...
		$.ajax({
			...
			url :"shiftStockSeed.do?flag=getDingdanApp",
			dataType : "json",
			success : function(obj) {
				if (obj.qingkong == "clean") {
					alert("没有数据！");
...
function selectGuohuBut() {	
	...
	$.ajax({
		...
		url :"shiftStockSeed.do?flag=getDingdanAppTj",
		dataType : "json",
		success : function(obj) {
			if (obj.qingkong == "clean") {
				alert("没有数据！");
