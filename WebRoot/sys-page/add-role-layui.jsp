					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<c:forEach items="${listInteriorUserDuty }" var="lp"
								varStatus="v">
								<tr>
									<td>${v.index+1 }<input type="hidden" class="id" value="${lp.interiorUserDutyId }"></td>
