    ...
    <script type="text/javascript">
    	$(function(){
			...
			$(".closeOk").click(function(){
				document.location.href="${pageContext.request.contextPath}/goodsUnit.do?flag=selectGoodsUnit";
			});	
    	});
    	function fun(){
    ...
    <div id="mainFrame" class="main">
        <div class="daohang">
            <ul><i>当前位置：</i> 
                ...
                <a style="cursor:pointer;">计件单位</a> <span>></span>&nbsp;
            </ul>
        </div>
        <div class="container">
            <ul class="nav nav-tabs nav-pills" style="margin: 10px 2.5%; font-weight: bold;">
                ...
                <span class="glyphicon glyphicon-plus" aria-hidden="true" style="margin-right: 8px;"></span>新增计件单位</a></li>
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:if test="${listGoodsUnit==null }">
                        		<c:redirect url="/goodsUnit.do?flag=selectGoodsUnit" />
                        	</c:if>
                        	<c:forEach items="${listGoodsUnit }" var="lp" varStatus="v">
                            <tr>
                                <td>${v.index+1 }<input type="hidden" class="id" value="${lp.goodsUnitId }"></td>
                                <td>${lp.goodsUnitName }</td>
                                <td>${lp.goodsUnitDefinedTwo }</td>
                                <td>${lp.goodsUnitRemark }</td>
                                <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/goodsUnit.do?flag=stopGoodsUnit&id=${lp.goodsUnitId }">确定</a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
                ...
                <div id="menu1" class="tab-pane fade">
                    <div class="modal-content" style="margin: auto 30%;">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">新增计件单位</h4>
                        </div>
                        
                       <form  class="form-horizontal" 
                            method="post"  name="goodsUnitForm" 
                            action="${pageContext.request.contextPath}/goodsUnit.do?flag=addGoodsUnit" onSubmit="return fun()">
                        <div class="modal-body">
                                <div class="form-group">
                                    <label for="zhanghao" class="col-sm-3 control-label">单位名称</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control gpName" name="goodsUnitName">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inpassword" class="col-sm-3 control-label">描述</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inpassword" name="goodsUnitDefinedTwo">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">备注</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="name" name="goodsUnitRemark">
                                    </div>
                                </div>
                ...
                <div id="menu2" class="tab-pane fade">
                    <div class="modal-content" style="margin: auto 30%;">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">编辑计件单位</h4>
                        </div>
                        
                        <form class="form-horizontal"  name="goodsUnitForm" 
                                method="post" action="${pageContext.request.contextPath}/goodsUnit.do?flag=updateGoodsUnit" onSubmit="return fun2()">
                        <div class="modal-body">
                                <input type="hidden" id="cdId" name="goodsUnitId"/>
                                <div class="form-group">
                                    <label for="zhanghao" class="col-sm-3 control-label">单位名称</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="caizhiName" name="goodsUnitName">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inpassword" class="col-sm-3 control-label">描述</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="miaoshu" name="goodsUnitDefinedTwo">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">备注</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="beizhu" name="goodsUnitRemark">
                                    </div>
                                </div>
                        </div>
                        <div class="modal-footer">
